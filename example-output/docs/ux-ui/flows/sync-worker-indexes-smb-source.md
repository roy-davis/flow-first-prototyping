...
# Flow: Index SMB source

> File: docs/ux-ui/flows/sync-worker-indexes-smb-source.md
> Primary actor: Sync Worker
> Story: sync-worker-indexes-smb-source.md
> Journey: sam-connects-smb-library.md
> Implements: Indexing and handoff

- Trigger: Sam selects the SMB library folder.
...
- Steps:
  ...
  3. Actor takes the primary action for "Index SMB source".
...
- Exit states: Discovered books are available for review, or sync explains skipped items.
- Completion criteria: Discovered books are available for review, or sync explains skipped items.
